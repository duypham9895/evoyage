...
- See real-time charging station availability from VinFast's network (<!-- STATIONS_COUNT_START -->19,528+<!-- STATIONS_COUNT_END --> stations, 63 provinces — auto-updated daily after the crawl)
...
<!-- ENERGY_PRICES_START -->
  - Gasoline RON 95-III: ₫25,540 / liter (Petrolimex)
  - Diesel DO 0,05S: ₫28,760 / liter (Petrolimex)
